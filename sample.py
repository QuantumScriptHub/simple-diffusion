...
def get_loader(cfg):
    ...
    nju2k_test_dataset = DataLoader(
        nju2k_test_dataset,
        batch_size=cfg.batch_size,
        collate_fn=collate
    )

    return nju2k_test_dataset
...
if __name__ == "__main__":
    ...
    parser.add_argument('--target_dataset', nargs='+', type=str, default=['NJU2K'])
    ...
    nju2k_test_loader = get_loader(cfg)
    ...
    nju2k_test_loader = trainer.accelerator.prepare(nju2k_test_loader)
    ...
    for dataset, dataset_name in target_dataset:
        trainer.model.eval()
        mask_path = Path(cfg.test_dataset.NJU2K.params.image_root).parent.parent
